...
![Создание рабочего каталога](image/2.png){#fig:001 width=70%}

Ввожу в созданный файл программу из первого листинга (рис. -@fig:002).

![Программа первого листинга](image/3.png){#fig:002 width=70%}
...
![Запуск программы первого листинга](image/4.png){#fig:003 width=70%}
...
![Демонстрация команды chmod](image/5.png){#fig:004 width=70%}
...
![Запуск текстового файла](image/6.png){#fig:005 width=70%}
...
1. В символьном виде для 1-го readme файла rwx rwx --x
2. В двоичной системе для 2-го readme файла 110 111 101
...
![Символьная и числовая записи](image/9.png){#fig:006 width=70%}

2. В двоичной системе для 2-го readme файла 110 111 101 (рис. -@fig:008).  

![числовая запись](image/11.png){#fig:008 width=70%}
...
![Демонстрация работы программы](image/10.png){#fig:007 width=70%}

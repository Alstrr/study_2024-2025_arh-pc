...
![использование make](image/1.png){#fig:2 width=70%}
![Проверка](image/4.png){#fig:3 width=70%}
...
![Удаление сгенерированных шаблонов](image/4.png){#fig:4 width=70%}
...
![Скачивание mousepad](image/5.png){#fig:5 width=70%}

![Подготовка отчёта](image/6.png){#fig:6 width=70%}
...
![Выполнение отчета по 2 лабораторной работе](image/10.png){#fig:7 width=70%}
